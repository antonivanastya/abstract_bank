...
bank = Bank()
bank.add_customer('test', 'passed', '12345')
bank.add_customer('test', 'passed', '54321')
bank.add_account(BankAccount(12345, 'USD'), bank.get_customer('12345'))
bank.add_account(BankAccount(123456, 'USD'), bank.get_customer('54321'))
bank.deposit('12345', 100)
bank.deposit('54321', 100)
